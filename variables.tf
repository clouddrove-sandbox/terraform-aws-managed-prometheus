...
variable "repository" {
  type        = string
  default     = "https://github.com/clouddrove/terraform-aws-managed-prometheus"
...
#Description : Provides an Amazon Managed Service for Prometheus workspace resource.
variable "enabled" {
  description = "Flag to control whether resources are created."
  type        = bool
  default     = true
}
